        ...
        {isEditing ? (
          <div>
            <textarea
              ...
              rows={3}
              className="w-full bg-white resize-none outline-none text-gray-700 text-sm leading-relaxed rounded-xl p-3 border border-orange/30 focus:border-orange/50"
            />
          ...
          <>
            <p
              className="text-gray-700 text-sm leading-relaxed pr-6 cursor-pointer hover:text-gray-900"
